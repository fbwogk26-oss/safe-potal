...
import { Heart, Plus, Trash2, Pencil, FileText, ChevronLeft, ChevronRight, CheckCircle2, AlertCircle, Loader2, Calendar, Paperclip, X, TrendingUp, CalendarDays, Download } from "lucide-react";
                ...
                <div className="flex gap-2">
                  <Button variant="outline" size="sm" className="gap-1.5 text-rose-600 border-rose-300 hover:bg-rose-50"
                    onClick={() => {
                      ...
                      a.href = `/api/health-manager-reports/${detailReport.id}/download-signed`;
                      a.download = "";
