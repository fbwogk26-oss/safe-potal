...
export default function MusicManager() {
  ...
  const { data: schedule, isLoading: scheduleLoading } = useQuery<MusicSchedule>({
  ...
  const handleUpload = () => {
    ...
    formData.append("scheduleType", uploadScheduleType);
            ...
            <div className="flex items-center gap-2 flex-1">
              <Input
                ...
                onChange={(e) =>
                  setScheduleForm({
                    ...currentSchedule,
                    checkin: { ...currentSchedule.checkin, start: e.target.value },
                  })
                }
              ...
              <Input
                ...
                onChange={(e) =>
                  setScheduleForm({
                    ...currentSchedule,
                    checkin: { ...currentSchedule.checkin, end: e.target.value },
                  })
                }
                className="w-32 text-sm"
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                onChange={(e) =>
                  setScheduleForm({
                    ...currentSchedule,
                    checkin: { ...currentSchedule.checkin, enabled: e.target.checked },
                  })
                }
            ...
            <div className="flex items-center gap-2 flex-1">
              <Input
                ...
                onChange={(e) =>
                  setScheduleForm({
                    ...currentSchedule,
                    checkout: { ...currentSchedule.checkout, start: e.target.value },
                  })
                }
                className="w-32 text-sm"
              ...
              <Input
                ...
                onChange={(e) =>
                  setScheduleForm({
                    ...currentSchedule,
                    checkout: { ...currentSchedule.checkout, end: e.target.value },
                  })
                }
                className="w-32 text-sm"
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                onChange={(e) =>
                  setScheduleForm({
                    ...currentSchedule,
                    checkout: { ...currentSchedule.checkout, enabled: e.target.checked },
                  })
                }
